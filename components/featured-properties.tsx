      ...
      <div className="p-6">
        ...
        <div className="mt-5 flex items-center justify-end">
          <a
            ...
            className="rounded-sm border border-border px-4 py-2 text-xs uppercase tracking-[0.15em] text-foreground transition-all duration-300 ease-luxe hover:border-gold hover:text-gold active:scale-[0.97]"
          >
            Enquire
          </a>
        </div>
