...
const lifestyles = [
  ...
  { name: "Downtown", mood: "City in motion", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-o9RMiOTrCz30g6J7qC9NRhtSk5HETA.png" },
...
export function LifestyleHero() {
  ...
  return (
    <section className="lifestyle-hero relative isolate min-h-[min(920px,100vh)] overflow-visible bg-background">
      <div className="lifestyle-hero__image absolute inset-0" key={lifestyle.image} style={{ backgroundImage: `url(${lifestyle.image})`, backgroundPosition: lifestyle.name === "Palm Jumeirah" ? "center calc(0% - 10px)" : lifestyle.name === "Dubai" || lifestyle.name === "Downtown" ? "center calc(100% + 90px)" : lifestyle.name === "Dubai Marina" ? "center calc(100% + 80px)" : undefined }} aria-hidden="true" />
