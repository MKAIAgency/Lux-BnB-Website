...
const defaultDubai = { name: "Dubai", mood: "City in motion", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image.png-pRf1m1W6Hbq5wEP3NeofDDABmUtmJ2.jpeg" }
...
const lifestyles = [
  ...
  { name: "Downtown", mood: "City in motion", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image.png-pRf1m1W6Hbq5wEP3NeofDDABmUtmJ2.jpeg" },
...
export function LifestyleHero() {
  ...
  const lifestyle = activeIndex >= 0 ? lifestyles[activeIndex] : defaultDubai

  return (
    <section className="lifestyle-hero relative isolate min-h-[min(920px,100vh)] overflow-visible bg-background">
      <div className="lifestyle-hero__image absolute inset-0" key={lifestyle.image} style={{ backgroundImage: `url(${lifestyle.image})`, backgroundPosition: lifestyle.name === "Palm Jumeirah" ? "center 0%" : undefined }} aria-hidden="true" />
      {activeIndex >= 0 ? <div className="lifestyle-hero__contrast absolute inset-0" aria-hidden="true" /> : null}
