...
export function LifestyleHero() {
  ...
  return (
    <section className="lifestyle-hero relative isolate min-h-[min(920px,100vh)] overflow-visible bg-background">
      <div className="lifestyle-hero__image absolute inset-0" key={lifestyle.image} style={{ backgroundImage: `url(${lifestyle.image})`, backgroundPosition: lifestyle.name === "Palm Jumeirah" ? "center 0%" : lifestyle.name === "Dubai" || lifestyle.name === "Downtown" ? "center 75%" : undefined }} aria-hidden="true" />
